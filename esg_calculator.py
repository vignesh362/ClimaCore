...
if st.session_state.submitted:
    ...
    st.header("Processing Your Survey Results")
    ...
    resp={}
    resp["Climate Data"]=climate_data
    resp["bio_diversity Data"]=bio_diversity_data
    resp["time_frame_summary Data"]=time_frame_summary
    resp["Soil_data Data"]=Soil_data
